...
profile = Profile.create! name: "Nick", surname: "Bruman", profile_photo: "http://upload.wikimedia.org/wikipedia/commons/c/cc/Ursynalia_2012,_Mastodon_03.jpg", description: "just living life, bru", video: "youtubelink.youtube.com", email: "email@email.com", phone: "333-333-3333"

Talent.delete_all

Talent.create!(skill: "piano")
Talent.create!(skill: "drums")
Talent.create!(skill: "acoustic guitar")
